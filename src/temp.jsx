  ...
  <div className="lg:hidden">
    <button onClick={toggleMenu} className="text-gray-500 focus:outline-none">
      <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" width="24" height="24">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M4 6 h 16 M 4 12 h 16 m -16 6 h 16" />
...
const NavItem = ({ to, children }) => {
  ...
  const setActiveLinkStyles = ({ isActive }) => {
    return isActive ? `${baseStyles} font-semibold` : `${baseStyles} font-normal transition duration-200 hover:text-zinc-300`
  }
  return (
    <li>
...
const MobileMenu = ({isMenuOpen}) => (
  <div className={`lg:hidden ${isMenuOpen ? "block" : "hidden"} absolute left-0 shadow-md `}>
